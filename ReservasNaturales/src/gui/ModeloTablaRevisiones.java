...
public class ModeloTablaRevisiones extends AbstractTableModel {
    ...
    public Class<?> getColumnClass(int col) {
        ...
        switch (col) {
            case 0: 
            case 1: 
            case 4: clase = String.class; break;
    ...
    public Object getValueAt(int row, int col) {
        ...
        switch (col) {
            ...
            case 4: resultado = r.getInforme(); break;
        }
        return resultado;
    }
    ...
    public void setValueAt(Object aValue, int row, int col) {
        ...
        switch (col) {
            ...
            case 1: r.setEjemplar((String) aValue); break;
            case 2: r.setEspecieAsociada((Integer) aValue); break;
            case 3: r.setFechaRevision((Date) aValue); break;
            case 4: r.setInforme((String) aValue); break;
        }
