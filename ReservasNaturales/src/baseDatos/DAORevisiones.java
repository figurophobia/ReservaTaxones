...
public class DAORevisiones extends AbstractDAO{
    ...
    try {
        String consulta = "SELECT clinica, ejemplar, especie_asociada, fecha_revision, informe " +
                          "FROM revisiones WHERE clinica = ? AND especie_asociada = ?";
        ...
        while (rsRevision.next()) {
            ...
            String ejemplar = rsRevision.getString("ejemplar");
            int especieAsociada = rsRevision.getInt("especie_asociada");
